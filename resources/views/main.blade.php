...
<head>
    ...
    <title>Chatplay - Play while you Chat or Chat while you Play!</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('js/jScrollPane/jScrollPane.css') }}" />
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <p class="navbar-brand page-scroll">
                <i class="fa fa-play-circle"></i>  <span class="light">Play</span> Chat
            </p>
        </div>
